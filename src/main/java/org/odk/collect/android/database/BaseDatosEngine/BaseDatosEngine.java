...
import org.odk.collect.android.database.BaseDatosEngine.EstructuraBD.ColumnasService;
...
public class BaseDatosEngine {
    ...
    public boolean EliminarRegistrosConfiguracion() {
        ...
        public Cursor listar(String[] argumentos, String op, String where) {
            ...
            Cursor c = null;
            try {
            /*if (op.toString().equals(("c"))) {
                c = db.query(Tablas.LocalesEngine, campos, "code like ?", argumentos, null, null, null);
            }
            if (op.toString().equals("n")) {
                c = db.query(Tablas.LocalesEngine, campos, "name like ?", argumentos, null, null, null);
            }*/
                String query = "";
